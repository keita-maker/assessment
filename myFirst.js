...
assessmentButton.onclick = function() {
  ...
  resultDivided.appendChild(main);

  removeAllChild(tweetDivided);
  const tweet = document.createElement('a');
  const hrefContent = 'https://twitter.com/intent/tweet?button_hashtag=' + 
  encodeURIComponent('あなたのいいところ') + '&ref_src=twsrc%5Etfw';
  tweet.setAttribute('href', hrefContent);
  tweet.className = 'twitter-hashtag-button';
...
function assessment(userName) {
    ...
    const index = number % answers.length;
